...
export const mockConversations: Conversation[] = [
  {
    ...
    lastMessageId: 3,
    book: mockBooks.find(b => b.id === 3),
    participant: mockUsers.find(u => u.id === 1),
  ...
  },
  {
    ...
    participant: mockUsers.find(u => u.id === 2),
    ...
    messages: [
      {
        ...
        conversationId: "2",
        senderId: 2,
        content: "Hello! I saw your listing for 'The Lord of the Rings'. Can you meet tomorrow?",
